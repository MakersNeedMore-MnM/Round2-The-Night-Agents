...
export interface ClinicalQuestion {
  id: string;
  category: 'CHIEF_COMPLAINT' | 'HPI' | 'ASSOCIATED' | 'PAST_HISTORY' | 'MEDICATION' | 'ALLERGY' | 'AYUSH';
  questionEn: string;
  questionHi: string;
...
export interface ClinicalPathway {
  complaintKey: string;
  complaintNameEn: string;
  complaintNameHi: string;
  keywordsEn: string[];
  keywordsHi: string[];
  initialQuestionId: string;
  questions: Record<string, ClinicalQuestion>;
  nextQuestionLogic: (answersSoFar: Record<string, any>, lastAnsweredId: string) => string | null;
}

export const CHEST_PAIN_PATHWAY: ClinicalPathway = {
...
export const AYUSH_AYURVEDA_PATHWAY: ClinicalPathway = {
